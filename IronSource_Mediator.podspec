...
s.author       = "Team"
s.platform     = :ios, "11.2"
s.source       = {:git => 'https://bitbucket.org/vdopia/sdkdistribution.git',:tag => '3.1.3'}
...
s.vendored_libraries = "libIronSourceMediator.a"
s.dependency 'Chocolate_SDK', '~> 1.0.0'
s.dependency 'IronSourceSDK','6.7.3.1'
s.requires_arc = true
end
